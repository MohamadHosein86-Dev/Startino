  ...
  return (
    <section className="  mb-100 ">
      <div className=" relative ">
        <div
          className="absolute  left-1/2 top-0 transform -translate-x-1/2 w-full md:w-360 h-[570px] bg-no-repeat bg-cover z-10"
          style={{
            backgroundImage: "url('home/cart/Tooltip.png')",
            backgroundPosition: "center"
          }}
        ></div>
        <div className=" z-1000 relative flex items-center gap-4 justify-center mt-20 ">
          {companies.map((res) => (
            <div key={res.name} className=" cursor-pointer basis-[19%] pb-6 rounded-xl bg-white">
              ...
              <div className=" px-3.5 flex items-center justify-between ">
                ...
                <Image width={50} height={50} className=" mt-4 " src={res.logo} alt={res.name} />
              </div>
              ...
              <div className="  px-3.5 mt-2 line-clamp-2 ">
